[
  {"deps/phoenix/lib/phoenix/router.ex", "The pattern can never match the type."},
  ...
  {"test/support/data_case.ex", "The pattern can never match the type."},
  {"test/support/conn_case.ex", "The pattern can never match the type."}
]
